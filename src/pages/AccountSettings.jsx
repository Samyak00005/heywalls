  ...
  return (
    <div className="container-page pt-xl pb-3xl md:pb-4xl">
      <div className="max-w-[420px] mx-auto">
        ...
        <form onSubmit={handleSave} className="flex flex-col gap-lg mb-3xl">
        ...
        <form onSubmit={handlePasswordChange} className="flex flex-col gap-lg mb-3xl">
          <label className="flex flex-col gap-xs">
        ...
        <div className="border-t border-line pt-xl">
