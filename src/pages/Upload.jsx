      ...
      <div className="grid lg:grid-cols-[minmax(0,760px)_minmax(260px,1fr)] gap-2xl lg:gap-4xl items-start">
        <section>
          <div className="mb-xl">
            ...
            <p className="text-body-sm text-ink-soft">Share a mobile, tablet, or desktop wallpaper with the HeyWalls community.</p>
          </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-lg">
            ...
            {ORIENTATIONS.map((o) => (
              <button
                ...
                className={
                  ...
                  (orientation === o.value ? 'border-ink text-ink' : 'border-line text-ink-soft')
                }
              >
                {o.label}
              </button>
        ...
        <aside className="hidden lg:block border-l border-line pl-2xl sticky top-xl">
          ...
          <div className="space-y-lg text-body-sm text-ink-soft">
            ...
            <div>
              <p className="text-ink mb-xs">Mobile</p>
              <p>Use a 9:16 image such as 1080 × 1920 or 1440 × 2560.</p>
            </div>
            <div>
              <p className="text-ink mb-xs">Tablet</p>
              <p>Use a 4:3 image such as 2048 × 1536 or 2732 × 2048.</p>
            </div>
            <div>
