...
export default function Upload() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      showToast(
        profile?.role === "admin"
          ? "Wallpaper added and published."
          : "Wallpaper added — pending review.",
      );
        ...
        <section>
          <div className="mb-xl">
            ...
            <p className="text-body-sm text-ink-soft">
              Share a 9:16 phone or 16:9 desktop wallpaper with the HeyWalls
              community.
            </p>
          </div>
        ...
        <aside className="hidden lg:block border-l border-line pl-2xl sticky top-xl">
          ...
          <div className="space-y-lg text-body-sm text-ink-soft">
            ...
            <div>
              ...
              <p>
                The uploaded file's real width and height are stored
                automatically and shown on its detail page.
              </p>
            </div>
          </div>
