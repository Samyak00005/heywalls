...
const VARIANTS = {
  profile: {
    ...
    title: 'Account hub',
    description: 'Manage your wallpapers, favourites, collections, and account from one place.',
    links: [
  ...
  wallpapers: {
    ...
    description: 'Manage your uploaded wallpapers, collections, and account from one place.',
    links: [
        ...
        {config.deleteDivider && (
          <div className="border-t border-line pt-md mt-md">
            {onDeleteAccount ? (
              ...
              <a href={`${profilePath}#delete-account`} className="block text-accent-2 hover:underline">
                Delete account →
              </a>
            )}
          </div>
